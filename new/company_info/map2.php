...
<div id="sub_wrap">
	...
	<div class="content_wrap">
		...
		<div class="content">	
			...
			<ul>
			<li><a href="map1.php"><span>윈투스시스템<b> 본사</b></span></a></li>
			<li  class="selected"><a href="map2.php"><span>윈투스시스템<b> 공장</b></span></a></li>
			</ul>
			</div>
			<!--텝메뉴 : 종료-->
			<div class="map">
				<h1 class="txt01">공장</h1>
				<div class="map_contents">
					<dl class="description_list01 type1">
						<dt>Adrees</dt>
						<dd>(도로명)서울특별시 성동구 뚝섬로 424 (성수동2가) <br>(지번) 서울시 성동구 성수동 2가 263-10</dd>
					</dl>
					<dl class="description_list01 type1">
						<dt>Tel</dt>
						<dd>070-7798-3698 </dd>
				...
				<script>
					var mapContainer = document.getElementById('map_daum'), // 지도를 표시할 div 
						mapOption = { 
							center: new kakao.maps.LatLng(37.540216, 127.054542), // 지도의 중심좌표
							level: 3 // 지도의 확대 레벨
						};
					...
					/*
					// 마커가 표시될 위치입니다 
					var markerPosition  = new kakao.maps.LatLng(37.540216, 127.054542); 
					...
					*/
					...
					var markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption),
						markerPosition = new kakao.maps.LatLng(37.540216, 127.054542); // 마커가 표시될 위치입니다
