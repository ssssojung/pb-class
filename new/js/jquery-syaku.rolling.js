...
(function($) {
  ...
  $.fn.srolling = function(settings) {
    ...
    settings = jQuery.extend({
      ...
      cache_count : 3, // 최초 한번 임시로 생성될 아이템 수 (고치지마세요)
      width : 5000, // 노출될 아이템 크기 (필수 : 실제 아이템 보다 약간 크게 설정하세요)
      height : 381, // 노출될 아이템 크기 (필수 : 실제 아이템 보다 약간 크게 설정하세요)
      auto : false, // 자동 이동 설정
      delay : 2000, // 자동 이동 후 대기 시간
      delay_frame : 1000, // 이동 속도 (움직이는 효과를 없애고 싶으면 0)
      move : 'right', // 이동 방향 left , right , up , down 
