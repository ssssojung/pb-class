...
<div id="header_wrap">
	<h1 class="logo"><a href="index_main.php"><img src="./images/hd_logo.png" alt="윈투스시스템"></a></h1>
	<!-- TOP MENU 시작 -->
	<div>
		<ul id="nav">
			<li><a href="#">회사소개 </a></li>
			...
			<li><a href="product_info/goods_cctv.php">제품  </a>
				<ul style="margin-left:-25px;">
					<li><a href="" >카메라 WTS-P2036R</a></li>
					<li><a href="">카메라 WTS-B2004R</a></li>
					<li><a href="">카메라 WTS-B2004R</a></li>
					<li><a href="">CCTV 스마트 제어 (TM-SC09)</a></li> 
					<li><a href="">CCTV 스마트 제어 (TM-SC02)</a></li>
					<li><a href="">CCTV 스마트 제어 (TM-SC02)</a></li>
				</ul>
			</li>
...
<div class="footer_wrap">
	...
	<div class="footer">
		...
		본사 : 서울시 성동구 성수동 2가 333-15 서울숲 한라시그마벨리2 9층 905호   |   공장 : 서울시 성동구 성수동 2가 263-10    |   TEL : 070) 7798-3698    FAX : 02) 6455-3698 <br>
