	...
	<div class="content_wrap">
		...
		<div class="cctv_write_wrap">
			<form id="frmCCTVWrite" name="frmCCTVWrite" method="post" action="goods_cctv_write_proc.php" enctype="multipart/form-data">
				<fieldset>
					<legend>새로운 CCTV 제품을 등록하실 수 있습니다.</legend>
					<ul>
						<li>
						<label for=""><b class="icon_start">＊</b> 제품명</label>
						<input type="text" id="wp_modelname" name="wp_modelname"/>
						</li>
					</ul>
					<ul>
						<li>
						<label for=""><b class="icon_start">＊</b> 리스트이미지</label>
						<input type="file" id="wp_productimage" name="wp_productimage"/>
						</li>
					</ul>
					<ul>
						<li style="height:60px;">
						<label for=""><b class="icon_start">＊</b> 리스트제목</label>
					...
					<ul>
						<li>
						<label for=""><b class="icon_start">＊</b> 상세보기이미지(도면)</label>
						<input type="file" id="wp_modelplan" name="wp_modelplan" />
						</li>
					</ul>
					<ul>
						<li style="height:60px;">
						<label for=""><b class="icon_start">＊</b> 제품 개요및 특징 요약설명</label>
						<textarea rows="3" cols="67" name="wp_feature2" id="wp_feature2"></textarea>
						</li>
					</ul>
					<ul>
						<li style="height:60px;">
						<label for=""><b class="icon_start">＊</b> 제품 개요및 특징1</label>
		...
		<div style="float:right;padding:30px 0;"><a href="javascript:product_check()" class="button5">저장</a> <a href="" class="button5">취소</a></div>
