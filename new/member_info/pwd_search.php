...
<div id="sub_wrap">
	...
	<div class="content_wrap">
		...
		<div class="content">	
			...
			<ul>
			<li ><a href="id_search.php"><span><b>아이디</b>찾기</span></a></li>
			<li class="selected"><a href="pwd_search.php"><span><b>비밀번호</b>찾기</span></a></li>
			</ul>
			</div>
			<!--텝메뉴 : 종료-->
			<div class="mem_wrap">
				<form action="pwd_search_proc.php" method="post" id="fmPwdSearch" name="fmPwdSearch">
					<fieldset>
						...
						<ul>
							...
							<label for="mail"><b class="icon_start">＊</b>이메일주소</label>
							 ...
							 <select id="" class="box01" style="margin-left:20px;">
			...
			<div style="float:right;padding:30px 0;"><a href="javascript:pwdSearch()" class="button2">확 인</a></div>
			<!-- 회원가입 : 종료 -->
