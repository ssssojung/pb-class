			...
			<form action="member_join_proc.php" method="post" id="fmMemberInfo" name="fmMemberInfo">
				<fieldset>
					...
					<ul>
						...
						<input type="text" id="tId" name="tId" style="margin-left:-143px;" value="test" />
						<a href="#" class="button2" onClick="javascript:goDetail('테스트');"> 중복확인</a>
						</li>
					</ul>
					<ul>
						<li>
						<label for="pw"><b class="icon_start">＊</b>비밀번호</label>
						<input type="password" id="tPassword1" name="tPassword1" value="1234"/>
						</li>
					...
					<ul>
						...
						<input type="password" id="tPassword2" name="tPassword2" value="1234" />
						</li>
						<li class="text01">특수문자, 한글, 공백을 포함할 수 있으며 모든 소문자를 처리합니다.( 6 ~ 10자 사이) </li>
					</ul>
					<ul>
						...
						<input type="text" id="tName" name="tName" value="홍길동" />
						</li>
					</ul>
					<ul>
						<li>
						<label for="mail"><b class="icon_start">＊</b>이메일주소</label>
						 <input type="text" id="tEmail1" name="tEmail1" class="box_m" style="margin:0 25px 0 52px;" value="test"/>
						 <span style="float:left;padding-right:10px;margin-top:3px;">＠</span>
						 <input type="text" id="tEmail2" name="tEmail2" class="box_m"  value="naver.com"/>
					...
					<ul>
						...
						<input type="text" id="tPhone1" name="tPhone1" class="box_s"  value="1212"/>
						<span style="float:left;padding:0 0px 0 10px;margin-top:3px;">-</span>
						<input type="text" id="tPhone2" name="tPhone2" class="box_s"  value="1212"/>
						</li>
					</ul>
					<ul>
						<li>
						...
						<span style="float:left;padding:0 0px 0 10px;margin-top:3px;">-</span>
						<input type="text" id="tMobile1" name="tMobile1" class="box_s"  value="1212"/>
						<span style="float:left;padding:0 0px 0 10px;margin-top:3px;">-</span>
						<input type="text" id="tMobile2" name="tMobile2" class="box_s"  value="2323"/>
						</li>
					</ul>
				</fieldset>
			</form>
